...
function LayoutPublicContent({ children }: LayoutPublicProps) {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden scroll-smooth" style={{ backgroundColor: '#022b28' }}>
      ...
      {/* Header */}
      <header id="navigation" className="border-b border-[#e6d1b8] fixed top-0 left-0 right-0 z-50" style={{ backgroundColor: 'rgba(245, 240, 232, 0.95)' }} role="banner">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-2 sm:py-3 lg:py-4">
            ...
            <nav className="hidden lg:flex space-x-6 xl:space-x-8 2xl:space-x-12" role="navigation" aria-label="Navegação principal">
              <button 
